...
public class TC11_PlatinumMotorcycle 
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "1,481.00", ExpClaim  = "Submit", ExpDis="5",ExpCover="Limited";
         ...
         System.out.println("Checking  for Motorcycle Insurance :----TC11_Platinum Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Motorcycle : TC11_Platinum Has completed--- ");
