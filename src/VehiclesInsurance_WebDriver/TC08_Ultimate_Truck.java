...
public class TC08_Ultimate_Truck {
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
       ...
       String  ExpPrice = "2,905.00", ExpClaim  = "Submit", ExpDis="10",ExpCover="Unlimited";
       ...
       System.out.println("Checking  for Truck Insurance :----TC09_Ultimate Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
     ...
     //5. Find  confirm password control 
       ...
       System.out.println();
       System.out.println("---Truck : TC08_Ultimate  Has completed--- ");
