...
public class TC09_SilverMotorcycle
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "256.00", ExpClaim  = "No", ExpDis="No",ExpCover="No";
         ...
         System.out.println("Checking  for Motorcycle Insurance :----TC09_Silver Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Motorcycle : TC09_Silver  Has completed--- ");
