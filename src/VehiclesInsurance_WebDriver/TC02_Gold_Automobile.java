...
public class TC02_Gold_Automobile
{
...
//Module-D :-------------------------------Select Price option: Gold  plan Selection--------------------------------------   
                                
         String  ExpPrice = "660.00", ExpClaim  = "Submit", ExpDis="2",ExpCover="Limited";
         ...
         System.out.println("Checking Automobile:----TC02_Gold Plan Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---TC02_Gold  Has been  completed--- ");
     }
}
