...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "777.00", ExpClaim  = "Submit", ExpDis="2",ExpCover="Limited";
         ...
         System.out.println("Checking  for Truck Insurance :----TC06_Gold Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Truck : TC02_Gold  Has completed--- ");
