...
public class TC01_Silver_Automobile
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "224.00", ExpClaim  = "No", ExpDis="No",ExpCover="No";
         ...
         System.out.println("Checking Automobile:----TC01_Silver Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---TC01_Silver Has completed--- ");
     }
}