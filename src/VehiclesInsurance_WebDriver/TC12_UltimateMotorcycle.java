...
public class TC12_UltimateMotorcycle
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "2,821.00", ExpClaim  = "Submit", ExpDis="10",ExpCover="Unlimited";
         ...
         System.out.println("Checking  for Motorcycle Insurance :----TC12_PUltimate Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Motorcycle : TC12_Ultimate Options Has completed--- ");
