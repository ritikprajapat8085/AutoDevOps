...
public class TC15_Platinum_Camper 
{
...
//Module-A :-----------------------------Enter Vehicle Data-------------------------------------
        ...
        // 1: locate make control 
          ...
          s.selectByVisibleText("BMW");           // select Audi using select class 
...
//Module-C :-------------------------------Enter Product  Data--------------------------------------   
              ...
              driver.findElement(By.id("startdate")).sendKeys("06/20/2025");  // shoud be future date i moth 
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "1,444.00.00", ExpClaim  = "Submit", ExpDis="5",ExpCover="Limited";
         ...
         System.out.println("Checking  for Campler Insurance :----TC15_ Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Camper : TC15_Platinum Has completed--- ");
