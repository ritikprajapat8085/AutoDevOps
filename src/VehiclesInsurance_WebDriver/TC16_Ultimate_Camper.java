...
public class TC16_Ultimate_Camper
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "2,750.00", ExpClaim  = "Submit", ExpDis="10",ExpCover="Unlimited";
         ...
         System.out.println("Checking  for Campler Insurance :----TC16_ Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Camper : TC16_Ultimate Has completed--- ");
