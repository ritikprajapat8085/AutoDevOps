...
public class TC04_Ultimate_Automation 
{
	...
	public static void main(String[] args) 
	{
		// TODO Auto-generated method stub
		 WebDriver driver = new ChromeDriver();
	 	 ...
	 	 //1.Part: ----------- locate Automobile Section------------------- 	  
	...
	//Module-A :-----------------------------Enter Vehicle Data-------------------------------------
	   ...
	   // 1: locate make control 
	     ...
	     s.selectByVisibleText("Audi");           // select Audi using select class 
	    ...
	    // 5: Locate fuel type
	     ...
	     // 7: locate liences plat number
	     driver.findElement(By.id("licenseplatenumber")).sendKeys("MP09CQ5246");
	...
	//Module-C :-------------------------------Enter Product  Data--------------------------------------   
	         ...
	         new Select(driver.findElement(By.id("insurancesum"))).selectByValue("3000000");
	     
	         // 3. Find  merit  rating
	        new Select(driver.findElement(By.id("meritrating"))).selectByValue("Super Bonus");
	     
	        // 4. Find damage insurance 
	        new Select(driver.findElement(By.id("damageinsurance"))).selectByValue("Partial Coverage");
	     
	        // 5.  find optional product & click   
	        ...
	        //7.Locate next button & click on it 
	       driver.findElement(By.id("nextselectpriceoption")).click();
	       

	       
	//Module-D :-------------------------------Select Price option: Ultimate plan Selection--------------------------------------   
	                           
	    String  ExpPrice = "2,468.00", ExpClaim  = "Submit", ExpDis="10",ExpCover="Unlimited";
	    ...
	    System.out.println("Checking Automobile:----TC04_Ultimate Plan Values----") ;
	...
	//Module:E :-------------------------------Send Quote--------------------------------------           
	  ...
	  //5. Find  confirm password control 
	    ...
	    System.out.println();
	    System.out.println("---TC04_Ultimate  Has been  completed--- ");
