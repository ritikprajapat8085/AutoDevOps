...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "735.00", ExpClaim  = "Submit", ExpDis="2",ExpCover="Limited";
         ...
         System.out.println("Checking  for Campler Insurance :----TC14_ Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Camper : TC14_Gold Has completed--- ");
