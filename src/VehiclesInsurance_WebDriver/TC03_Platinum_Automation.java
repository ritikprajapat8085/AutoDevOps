...
public class TC03_Platinum_Automation 
{
...
//Module-D :-------------------------------Select Price option: Platinum  plan Selection--------------------------------------   
                           
    String  ExpPrice = "1,295.00", ExpClaim  = "Submit", ExpDis="5",ExpCover="Limited";
    ...
    System.out.println("Checking Automobile:----TC03_Platinum Plan Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
  ...
  //5. Find  confirm password control 
    ...
    System.out.println();
    System.out.println("---TC03_Platinum  Has been  completed--- ");
}
}
