...
public class TC13_Silver_Camper
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "249.00", ExpClaim  = "No", ExpDis="No",ExpCover="No";
         ...
         System.out.println("Checking  for Campler Insurance :----TC13_Silver Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Camper : TC13_Silver  Has completed--- ");
