...
public class TC07_Platinum_Truck
{
...
//Module-D :-------------------------------Select Price option: Silver Plan Selection --------------------------------------   
         ...
         String  ExpPrice = "1,525.00", ExpClaim  = "Submit", ExpDis="5",ExpCover="Limited";
         ...
         System.out.println("Checking  for Truck Insurance :----TC07_Platinum Values----") ;
...
//Module:E :-------------------------------Send Quote--------------------------------------           
       ...
       //5. Find  confirm password control 
         ...
         System.out.println();
         System.out.println("---Truck : TC07_Platinum  Has completed--- ");
